 ...
 * 
 * 회원 테이블 수정 2016.07.28
 * ----------------------
 * mem_pass는 암호화 정책에 따라 처리(길이 연장)
 * tblAuthorities테이블 추가 생성
 */
...
ALTER TABLE tblAuthorities
ADD FOREIGN KEY R_7 (mem_num) REFERENCES tblMember(mem_num);
